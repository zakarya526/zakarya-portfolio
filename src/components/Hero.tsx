  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-20 w-2 h-2 bg-primary rounded-full animate-float opacity-60" style={{ animationDelay: '0s', animationDuration: '6s' }} />
        <div className="absolute top-40 right-32 w-1 h-1 bg-accent rounded-full animate-float opacity-40" style={{ animationDelay: '2s', animationDuration: '8s' }} />
        <div className="absolute bottom-40 left-32 w-3 h-3 bg-honey rounded-full animate-float opacity-50" style={{ animationDelay: '4s', animationDuration: '7s' }} />
        <div className="absolute top-60 right-20 w-1.5 h-1.5 bg-primary-glow rounded-full animate-float opacity-30" style={{ animationDelay: '1s', animationDuration: '9s' }} />
        
        {/* Large Glow Effects */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-radial from-primary/20 via-primary/5 to-transparent rounded-full blur-3xl animate-float" style={{ animationDelay: '0s', animationDuration: '12s' }} />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-radial from-accent/20 via-accent/5 to-transparent rounded-full blur-3xl animate-float" style={{ animationDelay: '6s', animationDuration: '10s' }} />
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12 animate-slide-up" style={{ animationDelay: '0.6s' }}>
              ...
              {/* Stats Section */}
              <div className="grid grid-cols-3 gap-6 max-w-md mx-auto lg:mx-0 animate-slide-up" style={{ animationDelay: '0.8s' }}>
                <div className="text-center lg:text-left">
            ...
            <div className="relative flex items-center justify-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="relative">
                {/* Floating Tech Icons */}
                <div className="absolute -top-4 -left-4 w-16 h-16 bg-gradient-hero rounded-2xl flex items-center justify-center shadow-glow animate-float z-10" style={{ animationDelay: '0s' }}>
                  <Code className="w-8 h-8 text-primary-foreground" />
                </div>
                <div className="absolute -top-4 -right-4 w-14 h-14 bg-gradient-to-br from-accent to-accent-glow rounded-xl flex items-center justify-center shadow-elegant animate-float z-10" style={{ animationDelay: '1s' }}>
                  <Smartphone className="w-7 h-7 text-accent-foreground" />
                </div>
                <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-honey rounded-lg flex items-center justify-center shadow-honey animate-float z-10" style={{ animationDelay: '2s' }}>
                ...
                <div className="w-80 h-80 bg-gradient-to-br from-card via-card to-primary/5 rounded-3xl border border-border/50 shadow-elegant backdrop-blur-sm flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <h3 className="text-xl font-bold text-foreground mb-2">Muhammad Zakarya</h3>

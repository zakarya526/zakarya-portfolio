        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              A passionate full-stack developer with a keen eye for detail and a drive for excellence.
              I specialize in creating seamless digital experiences that blend functionality with beautiful design.
            </p>
          </div>
            ...
            <div className="animate-slide-up">
              <div className="space-y-6">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  software development, I've had the privilege of working on diverse projects ranging from 
                  mobile applications to enterprise-level web solutions.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  My journey began with Java development, and I've since expanded into the modern JavaScript 
                  ecosystem, specializing in React Native for mobile development and Next.js for web applications.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  I believe in <span className="text-accent font-semibold">continuous learning</span> and 
                  staying current with technology trends while maintaining a strong foundation in 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 animate-slide-up" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-honey mb-2">15+</div>

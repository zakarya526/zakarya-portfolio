...
const About = () => {
  const milestones = [
    ...
    },
    {
      ...
      description:
        "Delivered a complex e-commerce mobile app for a major retailer",
    },
    {
      year: "2022",
      title: "Founded Al Sarih Organics",
      description:
        "Launched organic food business, combining tech skills with entrepreneurship",
    },
    {
      year: "2023",
    ...
    },
    {
      ...
      description:
        "Expanded expertise to full-stack solutions and AI integration",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A passionate developer and entrepreneur who believes technology
          ...
          <div className="animate-slide-up">
            <Card className="bg-gradient-card border-border/50 shadow-elegant">
              ...
              <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Hi, I'm Muhammad Zakarya – a React Native developer and
                  digital entrepreneur with a passion for creating solutions
                  that bridge technology and real-world needs. My journey began
                  with a fascination for mobile technology and evolved into
                ...
                <p>
                  ...
                  , I've learned that great technology isn't just about clean
                  code – it's about understanding user needs, building
                  sustainable businesses, and creating products that people
                  genuinely love to use.
                </p>
                <p>
                  When I'm not coding or running my business, you'll find me
                  exploring new technologies, mentoring upcoming developers, or
                  experimenting with innovative ways to merge tech with
